...
DEMO_NAME = "demo_04_scalespace_refinement_ascending"
...
def find_sequence(layers, periods, symbols, global_start, global_target, args, recorder):
    ...
    while not any_target_found:
        ...
        recorder.record_expansion(scale, tick, global_start, targets, active_symbols, utils.intersect(targets, active_symbols))
